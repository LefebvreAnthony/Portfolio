...
export function AnimationHome() {
    ...
    const KE1 = new KeyframeEffect(doorLeft, { left: "-50%" }, { duration: 2000, easing: "cubic-bezier(.93, .06, .72, .73)", fill: "forwards" });
    const KE2 = new KeyframeEffect(doorRight, { right: "-50%" }, { duration: 2000, easing: "cubic-bezier(.93, .06, .72, .73)", fill: "forwards" });
